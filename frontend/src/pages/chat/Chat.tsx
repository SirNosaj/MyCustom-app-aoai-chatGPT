                    ...
                    <div className={styles.chatContainer}>
                        {!lastQuestionRef.current ? (
                            <Stack className={styles.chatEmptyState}>
                                ...
                                <h2 className={styles.chatEmptyStateSubtitle}>This advisor is trained to assist in writing Outdoor ED chapter proposals. Ask it for ideas or even to generate full sample proposals</h2>
                            </Stack>
                        ) : (
